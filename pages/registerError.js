...
function Register() {
  ...
  return (
    <div className={styles.container}>
      <Layout>
        <NavBar>
          <Nav.Link href="/login" style={{color:'darkviolet'}} >Iniciar Sesion</Nav.Link>
        </NavBar>
        <Row variant="success" className="justify-content-md-center">
          <Col xs="auto">
              
            <Form method="POST" action="api/register">
              <h1 className="text-center mt-5" style={{color:'darkviolet'}}>Bienvenido</h1>
              ...
              <Toast show={showA} onClose={toggleShowA}>
                ...
                <Toast.Body>
                  Ya tienes una cuenta registrada con ese email
                </Toast.Body>
              </Toast>
              ...
              <Form.Group controlId="formBasicPassword">
                ...
                />
                <Form.Text className="text-muted">
                  Al hacer clic en "Registrar", aceptas nuestras Condiciones,
                  <br />
